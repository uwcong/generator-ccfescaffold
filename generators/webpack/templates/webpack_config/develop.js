...
// 入口文件添加自动刷新、热替换配置
webpackConfig.entry.main.unshift("webpack-dev-server/client?http://0.0.0.0:" + hostPort + "/", "webpack/hot/dev-server");

var compiler = Webpack(webpackConfig);

//开启服务
var server = new WebpackDevServer(compiler, {
  // 指定服务器访问目录，这里 http://0.0.0.0:8080/tmpl/demo.html 访问的是模板页面
  contentBase: "./app/src",
